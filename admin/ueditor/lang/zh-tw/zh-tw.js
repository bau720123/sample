...
UE.I18N['zh-cn'] = {
    ...
    'background':{
        'static':{
            ...
            'repeatType':{'options':["居中", "橫向重覆", "縱向重覆", "平鋪","自定義"]}
    ...
    'wordimage':{
        'static':{
            ...
            lang_step:"1、點擊頂部覆制按鈕，將地址覆制到剪貼板；2、點擊添加照片按鈕，在彈出的對話框中使用Ctrl+V粘貼地址；3、點擊打開後選擇圖片上傳流程。"
        },
        'fileType':"圖片",
        'flashError':"FLASH初始化失敗，請檢查FLASH插件是否正確安裝！",
        'netError':"網絡連接錯誤，請重試！",
        'copySuccess':"圖片地址已經覆制！",
        'flashI18n':{} //留空默認中文
    },
    'autosave': {
        'saving':'保存中...',
