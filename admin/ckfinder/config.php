<?php require_once(dirname(__FILE__) . '/../../Connections/connection.php'); ?>
<?php
/*
...
function CheckAuthentication()
{
	...
	if(isset($_SESSION['admin_member_id'])) { return true; }
    if(empty($_SESSION['admin_member_id'])) { return false; }
	//return false;
}
