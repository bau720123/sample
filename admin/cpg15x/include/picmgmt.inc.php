...
$colname_qa_re = "-1";
if (isset($CURRENT_PIC_DATA['aid'])) {
  $colname_qa_re = $CURRENT_PIC_DATA['aid'];
}
mysql_select_db($database_connection, $connection);
$query_qa_re = sprintf("SELECT qa_re_id, qa_id FROM qa_re WHERE qa_re_id = %s", GetSQLValueString($colname_qa_re, "int"));
...
$baustring = "../upload/".$CURRENT_PIC_DATA['filepath'];
$bauthumb = "thumb_";
$query = "INSERT INTO class3 (class3_id, qa_re_id, qa_id, ready, class3_name, class3_inventory, class3_safe_inventory, photo, photo_thum, ontime, offtime, nowtime, sort) VALUES (NULL, '{$CURRENT_PIC_DATA['aid']}', '".$row_qa_re['qa_id']."', '1', '".addslashes($CURRENT_PIC_DATA['filename'])."', '99', '10', '".$baustring.addslashes($CURRENT_PIC_DATA['filename'])."', '".$baustring.$bauthumb.addslashes($CURRENT_PIC_DATA['filename'])."', '$nowtime', '".add_date($nowtime, '1', '0', '0')."', '$nowtime', '1')";
